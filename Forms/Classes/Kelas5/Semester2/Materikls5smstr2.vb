Public Class Materikls5smstr2
    ...
    Private Sub Materikls5smstr2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        With Button3
            .Parent = PictureBox1
        ...
        Call KoneksiDB()
        cmd = New OleDb.OleDbCommand("Select min(id) from data_materi where grade=5 and sub_bab='" & Button5.Tag & "'", conn)
        dr = cmd.ExecuteReader
        dr.Read()
